...
chrome_parm="--test-type --window-size=$chrome_window_size --no-sandbox --window-position=0,0 --user-data-dir=/config/google-chrome"
...
echo "while [ 1 ]; do /opt/google/chrome/google-chrome $chrome_parm; done" > "$vnc_config/xstartup"
